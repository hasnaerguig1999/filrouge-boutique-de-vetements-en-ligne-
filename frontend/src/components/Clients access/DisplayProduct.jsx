                  ...
                  <div className="ms-md-auto pe-md-3 d-flex align-items-center">
                    <div className="input-group input-group-outline">
                      <button className="btn btn-outline-primary btn-sm mb-0 me-0 p-0">
                        <Link className="nav-link text-primary" to="/AddProduct">Add More</Link>
                      </button>
  ...
  <tr key={product.id}>
    ...
    <td className="align-middle">
      <button className="btn border-none">
        <Link to={`/editProduct/${product.id}`} className="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit product">
          <FaEdit />
        </Link>
      </button>
    </td>
